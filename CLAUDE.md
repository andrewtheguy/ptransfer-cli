...
keep package.metadata.secure-send-web-version in Cargo.toml set to the exact secure-send-web version whose protocol this program implements, and update it whenever compatibility changes.
